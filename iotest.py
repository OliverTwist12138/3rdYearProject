...
def extractInfo(ds):
    ...
    return info
def main():
    path = "C:/Users/57035/Desktop/ELEC/3rd year/project/RSNA Chest Xray/images in initial annotation/1.2.276.0.7230010.3.1.2.8323329.1472.1517874291.114974/1.2.276.0.7230010.3.1.3.8323329.1472.1517874291.114973/1.2.276.0.7230010.3.1.4.8323329.1472.1517874291.114975.dcm"
    ds = dcmread(path)
    '''
    print(ds)
